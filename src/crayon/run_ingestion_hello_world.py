...
def build_indices(base_dir: str, db_name: str) -> BaseIndex:
    ...
    print(f"Creating Index {db_name}.....")
    index_strategy = IndexStrategies["simple"].create(db_name=db_name)
    index = index_strategy.build_index(
...
def main(base_dir: str):
    index = build_indices(base_dir=base_dir, db_name="HelloWorldIndex")
    print("Indices built!")
